...
typedef struct{
	...
	long long int nonce; /**< Nounce used to detect self. */
 ...
 */
CBVersion * CBNewVersion(int32_t version, CBVersionServices services, int64_t time, CBNetworkAddress * addRecv, CBNetworkAddress * addSource, long long int nonce, CBByteArray * userAgent, int32_t blockHeight);
