...
typedef struct{
	...
	unsigned int index; /**< The index of the output for this input */
} CBPrevOut;
...
typedef struct{
	...
	unsigned int sequence; /**< The version of this transaction input. Not used in protocol v0.3.18.00. Set to 0 for transactions that may somday be open to change after broadcast, set to CB_TX_INPUT_FINAL if this input never needs to be changed after broadcast. */
