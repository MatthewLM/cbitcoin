 ...
 */
struct CBMerkleNode{
	unsigned char hash[32]; /**< The hash for this node. */
 ...
 */
CBMerkleNode * CBBuildMerkleTree(CBByteArray ** hashes, int numHashes);
 ...
 */
CBMerkleNode * CBMerkleTreeGetLevel(CBMerkleNode * root, int level);
