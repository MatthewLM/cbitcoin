 ...
 */
typedef struct{
	unsigned char * data; /**< Pointer to byte data */
	int references; /**< References to this data */
}CBSharedData;
...
typedef struct{
	...
	int offset; /**< Offset from the begining of the byte data to the begining of this array */
