...
typedef struct{
	...
	long long int ID; /**< Used to identify a ping/pong. Set ping to zero if no identiication is needed. Set pongs to the same as the request ping. */
} CBPingPong;
...
*/
int CBPingPongSerialise(CBPingPong * self);
