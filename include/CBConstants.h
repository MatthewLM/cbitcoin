...
#define CBInt16ToArray(arr, offset, i) (arr)[offset] = (unsigned char)(i); \
									 (arr)[offset + 1] = (unsigned char)((i) >> 8);
#define CBInt32ToArray(arr, offset, i) CBInt16ToArray(arr, offset, i) \
									 (arr)[offset + 2] = (unsigned char)((i) >> 16); \
							         (arr)[offset + 3] = (unsigned char)((i) >> 24);
#define CBInt64ToArray(arr, offset, i) CBInt32ToArray(arr, offset, i) \
									 (arr)[offset + 4] = (unsigned char)((unsigned long long int)(i) >> 32); \
									 (arr)[offset + 5] = (unsigned char)((unsigned long long int)(i) >> 40); \
									 (arr)[offset + 6] = (unsigned char)((unsigned long long int)(i) >> 48); \
									 (arr)[offset + 7] = (unsigned char)((unsigned long long int)(i) >> 56);
#define CBArrayToInt16(arr, offset) ((arr)[offset] \
                                     | (unsigned int)(arr)[offset + 1] << 8)
#define CBArrayToInt32(arr, offset) (CBArrayToInt16(arr, offset) \
                                     | (unsigned int)(arr)[offset + 2] << 16 \
									 | (unsigned int)(arr)[offset + 3] << 24)
#define CBArrayToInt48(arr, offset) (CBArrayToInt32(arr, offset) \
                                     | (unsigned long long int)(arr)[offset + 4] << 32 \
                                     | (unsigned long long int)(arr)[offset + 5] << 40) 
#define CBArrayToInt64(arr, offset) (CBArrayToInt48(arr, offset) \
                                     | (unsigned long long int)(arr)[offset + 6] << 48 \
                                     | (unsigned long long int)(arr)[offset + 7] << 56)
...
#define CBInt64ToArrayBigEndian(arr, offset, i) CBInt32ToArrayBigEndian(arr, offset + 4, i) \
												(arr)[offset + 0] = (unsigned char)((unsigned long long int)(i) >> 56); \
												(arr)[offset + 1] = (unsigned char)((unsigned long long int)(i) >> 48);\
												(arr)[offset + 2] = (unsigned char)((unsigned long long int)(i) >> 40); \
												(arr)[offset + 3] = (unsigned char)((unsigned long long int)(i) >> 32);
#define CBArrayToInt32BigEndian(arr, offset) ((arr)[offset] << 24 \
                                              | (unsigned int)(arr)[offset + 1] << 16 \
                                              | (unsigned int)(arr)[offset + 2] << 8 \
                                              | (unsigned int)(arr)[offset + 3])
#define CBArrayToInt64BigEndian(arr, offset) (CBArrayToInt32BigEndian(arr, offset + 4) \
											  | (unsigned long long int)(arr)[offset] << 56 \
											  | (unsigned long long int)(arr)[offset + 1] << 48 \
											  | (unsigned long long int)(arr)[offset + 2] << 40 \
											  | (unsigned long long int)(arr)[offset + 3] << 32)
