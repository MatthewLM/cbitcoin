...
typedef struct{
	...
	unsigned char hash[32]; /**< The hash for this transaction. NULL if not set. */
	bool hashSet; /**< True if the hash has been set, false otherwise */
	int version; /**< Version of the transaction data format. */
	int inputNum; /**< Number of CBTransactionInputs */
	CBTransactionInput ** inputs;
	int outputNum; /**< Number of CBTransactionOutputs */
	CBTransactionOutput ** outputs;
	int lockTime; /**< Time for the transaction to be valid */
} CBTransaction;
