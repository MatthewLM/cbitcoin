...
typedef struct{
	...
	int hashNum; /**< Number of block hashes to describe the block chain. Up to 500. */
...
*/
int CBChainDescriptorDeserialise(CBChainDescriptor * self);
...
*/
int CBChainDescriptorSerialise(CBChainDescriptor * self);
