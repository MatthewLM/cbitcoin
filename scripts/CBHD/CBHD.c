...
XS(XS_CBitcoin__CBHD_exportChildIDFromCBHDKey); /* prototype to pass -Wmissing-prototypes */
XS(XS_CBitcoin__CBHD_exportChildIDFromCBHDKey)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	RETVAL = exportChildIDFromCBHDKey(privstring);
...
XS(XS_CBitcoin__CBHD_exportPrivChildIDFromCBHDKey); /* prototype to pass -Wmissing-prototypes */
XS(XS_CBitcoin__CBHD_exportPrivChildIDFromCBHDKey)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	RETVAL = exportPrivChildIDFromCBHDKey(privstring);
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(boot_CBitcoin__CBHD)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("CBitcoin::CBHD::exportChildIDFromCBHDKey", XS_CBitcoin__CBHD_exportChildIDFromCBHDKey, file);
        newXS("CBitcoin::CBHD::exportPrivChildIDFromCBHDKey", XS_CBitcoin__CBHD_exportPrivChildIDFromCBHDKey, file);
