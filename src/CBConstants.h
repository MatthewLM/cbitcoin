...
#define CB_LIBRARY_VERSION 4 // Goes up in increments
#define CB_LIBRARY_VERSION_STRING "1.0 alpha-4" // Features.Non-features pre-alpha/alpha/beta
#define CB_USER_AGENT_SEGMENT "/cbitcoin:1.0(alpha-4)/"
