...
int main(){
	...
	unsigned char keys[CB_BTREE_ELEMENTS][4];
	for (int x = 0; x < CB_BTREE_ELEMENTS; x++) {
		keys[x][0] = 3;
		keys[x][1] = rand();
		keys[x][2] = x;
		keys[x][3] = rand();
	...
	for (int x = 0; x < CB_BTREE_ELEMENTS; x++) {
		...
		if (x) {
			if (memcmp((unsigned char *)array.root->elements[x] + 1, (unsigned char *)array.root->elements[x-1] + 1, 3) <= 0) {
	...
	unsigned char keys2[CB_BTREE_ELEMENTS+1][4];
	for (int x = 0; x < CB_BTREE_ELEMENTS; x++) {
		keys2[x][0] = 3;
		keys2[x][1] = x;
		keys2[x][2] = 126;
	...
	// Left side
	key[0] = 3;
	for (int x = 0; x < CB_BTREE_HALF_ELEMENTS; x++) {
		key[1] = x;
		key[2] = 126;
		key[3] = 0;
	...
	// Right side
	for (int x = CB_BTREE_HALF_ELEMENTS; x < CB_BTREE_ELEMENTS; x++) {
		key[1] = x;
		key[2] = 126;
		key[3] = 0;
		res = CBAssociativeArrayFind(&array, key);
	...
	unsigned char keys3[CB_BTREE_HALF_ELEMENTS + 1][4];
	for (int x = 0; x < CB_BTREE_HALF_ELEMENTS; x++) {
		keys3[x][0] = 3;
	...
	unsigned char keys4[CB_BTREE_HALF_ELEMENTS + 1][4];
	for (int x = 0; x < CB_BTREE_HALF_ELEMENTS; x++) {
		keys4[x][0] = 3;
	...
	if (memcmp(array.root->elements[0], (unsigned char [4]){3, 16, 0, 0}, 4)
		&& memcmp(array.root->elements[1], (unsigned char [4]){3, 31, 126, 0}, 4)) {
	...
	if (memcmp(child0->elements[0], (unsigned char [4]){3, 0, 126, 0}, 4)
		&& memcmp(child0->elements[1], (unsigned char [4]){3, 2, 126, 0}, 4)
		&& memcmp(child0->elements[2], (unsigned char [4]){3, 3, 126, 0}, 4)
		&& memcmp(child0->elements[3], (unsigned char [4]){3, 4, 126, 0}, 4)
		&& memcmp(child0->elements[4], (unsigned char [4]){3, 5, 126, 0}, 4)
		&& memcmp(child0->elements[5], (unsigned char [4]){3, 6, 126, 0}, 4)
		&& memcmp(child0->elements[6], (unsigned char [4]){3, 7, 126, 0}, 4)
		&& memcmp(child0->elements[7], (unsigned char [4]){3, 8, 126, 0}, 4)
		&& memcmp(child0->elements[8], (unsigned char [4]){3, 9, 126, 0}, 4)
		&& memcmp(child0->elements[9], (unsigned char [4]){3, 10, 126, 0}, 4)
		&& memcmp(child0->elements[10], (unsigned char [4]){3, 11, 126, 0}, 4)
		&& memcmp(child0->elements[11], (unsigned char [4]){3, 12, 126, 0}, 4)
		&& memcmp(child0->elements[12], (unsigned char [4]){3, 13, 126, 0}, 4)
		&& memcmp(child0->elements[13], (unsigned char [4]){3, 14, 126, 0}, 4)
		&& memcmp(child0->elements[14], (unsigned char [4]){3, 15, 126, 0}, 4)
		&& memcmp(child0->elements[15], (unsigned char [4]){3, 15, 128, 0}, 4)
		&& memcmp(child0->elements[16], (unsigned char [4]){3, 15, 129, 0}, 4)
		&& memcmp(child0->elements[17], (unsigned char [4]){3, 15, 130, 0}, 4)
		&& memcmp(child0->elements[18], (unsigned char [4]){3, 15, 131, 0}, 4)
		&& memcmp(child0->elements[19], (unsigned char [4]){3, 15, 132, 0}, 4)
		&& memcmp(child0->elements[20], (unsigned char [4]){3, 15, 133, 0}, 4)
		&& memcmp(child0->elements[21], (unsigned char [4]){3, 15, 134, 0}, 4)
		&& memcmp(child0->elements[22], (unsigned char [4]){3, 15, 135, 0}, 4)
		&& memcmp(child0->elements[23], (unsigned char [4]){3, 15, 136, 0}, 4)
		&& memcmp(child0->elements[24], (unsigned char [4]){3, 15, 136, 127}, 4)
		&& memcmp(child0->elements[25], (unsigned char [4]){3, 15, 137, 0}, 4)
		&& memcmp(child0->elements[26], (unsigned char [4]){3, 15, 138, 0}, 4)
		&& memcmp(child0->elements[27], (unsigned char [4]){3, 15, 139, 0}, 4)
		&& memcmp(child0->elements[28], (unsigned char [4]){3, 15, 140, 0}, 4)
		&& memcmp(child0->elements[29], (unsigned char [4]){3, 15, 141, 0}, 4)
		&& memcmp(child0->elements[30], (unsigned char [4]){3, 15, 142, 0}, 4)
		&& memcmp(child0->elements[31], (unsigned char [4]){3, 15, 143, 0}, 4)) {
	...
	if (memcmp(child1->elements[0], (unsigned char [4]){3, 16, 126, 0}, 4)
		&& memcmp(child1->elements[1], (unsigned char [4]){3, 17, 126, 0}, 4)
		&& memcmp(child1->elements[2], (unsigned char [4]){3, 18, 126, 0}, 4)
		&& memcmp(child1->elements[3], (unsigned char [4]){3, 19, 126, 0}, 4)
		&& memcmp(child1->elements[4], (unsigned char [4]){3, 20, 126, 0}, 4)
		&& memcmp(child1->elements[5], (unsigned char [4]){3, 21, 126, 0}, 4)
		&& memcmp(child1->elements[6], (unsigned char [4]){3, 22, 126, 0}, 4)
		&& memcmp(child1->elements[7], (unsigned char [4]){3, 23, 126, 0}, 4)
		&& memcmp(child1->elements[8], (unsigned char [4]){3, 24, 125, 0}, 4)
		&& memcmp(child1->elements[9], (unsigned char [4]){3, 24, 126, 0}, 4)
		&& memcmp(child1->elements[10], (unsigned char [4]){3, 25, 126, 0}, 4)
		&& memcmp(child1->elements[11], (unsigned char [4]){3, 26, 126, 0}, 4)
		&& memcmp(child1->elements[12], (unsigned char [4]){3, 27, 126, 0}, 4)
		&& memcmp(child1->elements[13], (unsigned char [4]){3, 28, 126, 0}, 4)
		&& memcmp(child1->elements[14], (unsigned char [4]){3, 29, 126, 0}, 4)
		&& memcmp(child1->elements[15], (unsigned char [4]){3, 30, 128, 0}, 4)
		&& memcmp(child1->elements[16], (unsigned char [4]){3, 31, 129, 0}, 4)
		&& memcmp(child1->elements[17], (unsigned char [4]){3, 32, 0, 0}, 4)
		&& memcmp(child1->elements[18], (unsigned char [4]){3, 32, 1, 0}, 4)
		&& memcmp(child1->elements[19], (unsigned char [4]){3, 32, 2, 0}, 4)
		&& memcmp(child1->elements[20], (unsigned char [4]){3, 32, 3, 0}, 4)
		&& memcmp(child1->elements[21], (unsigned char [4]){3, 32, 4, 0}, 4)
		&& memcmp(child1->elements[22], (unsigned char [4]){3, 32, 5, 0}, 4)
		&& memcmp(child1->elements[23], (unsigned char [4]){3, 32, 6, 0}, 4)
		&& memcmp(child1->elements[24], (unsigned char [4]){3, 32, 7, 0}, 4)
		&& memcmp(child1->elements[25], (unsigned char [4]){3, 32, 8, 0}, 4)
		&& memcmp(child1->elements[26], (unsigned char [4]){3, 32, 9, 0}, 4)
		&& memcmp(child1->elements[27], (unsigned char [4]){3, 32, 10, 0}, 4)
		&& memcmp(child1->elements[28], (unsigned char [4]){3, 32, 11, 0}, 4)
		&& memcmp(child1->elements[29], (unsigned char [4]){3, 32, 12, 0}, 4)
		&& memcmp(child1->elements[30], (unsigned char [4]){3, 32, 13, 0}, 4)
		&& memcmp(child1->elements[31], (unsigned char [4]){3, 32, 14, 0}, 4)) {
		printf("REMOVE [32, 15, 0] CHILD 1 DATA FAIL\n");
		return 1;
	}
	// Remove 17 elements from child1 to test taking element from left.
	for (int x = 0; x < CB_BTREE_HALF_ELEMENTS + 1; x++) {
	...
	if (memcmp(child0->elements[0], (unsigned char [4]){3, 0, 126, 0}, 4)
		...
		&& memcmp(child0->elements[6], (unsigned char [4]){3, 7, 126, 0}, 4)
		&& memcmp(child0->elements[7], (unsigned char [4]){3, 8, 126, 0}, 4)
		&& memcmp(child0->elements[8], (unsigned char [4]){3, 9, 125, 0}, 4)
		&& memcmp(child0->elements[9], (unsigned char [4]){3, 10, 126, 0}, 4)
		&& memcmp(child0->elements[10], (unsigned char [4]){3, 11, 126, 0}, 4)
		&& memcmp(child0->elements[11], (unsigned char [4]){3, 12, 126, 0}, 4)
		&& memcmp(child0->elements[12], (unsigned char [4]){3, 13, 126, 0}, 4)
	...
	if (memcmp(array.root->elements[0], (unsigned char [4]){3, 15, 143, 0}, 4)) {
	...
	if (memcmp(child1->elements[0], (unsigned char [4]){3, 16, 0, 0}, 4)
		&& memcmp(child1->elements[1], (unsigned char [4]){3, 32, 0, 0}, 4)
		&& memcmp(child1->elements[2], (unsigned char [4]){3, 32, 1, 0}, 4)
		&& memcmp(child1->elements[3], (unsigned char [4]){3, 32, 2, 0}, 4)
		&& memcmp(child1->elements[4], (unsigned char [4]){3, 32, 3, 0}, 4)
		&& memcmp(child1->elements[5], (unsigned char [4]){3, 32, 4, 0}, 4)
		&& memcmp(child1->elements[6], (unsigned char [4]){3, 32, 5, 0}, 4)
		&& memcmp(child1->elements[7], (unsigned char [4]){3, 32, 6, 0}, 4)
		&& memcmp(child1->elements[8], (unsigned char [4]){3, 32, 7, 0}, 4)
		&& memcmp(child1->elements[9], (unsigned char [4]){3, 32, 8, 0}, 4)
		&& memcmp(child1->elements[10], (unsigned char [4]){3, 32, 9, 0}, 4)
		&& memcmp(child1->elements[11], (unsigned char [4]){3, 32, 10, 0}, 4)
		&& memcmp(child1->elements[12], (unsigned char [4]){3, 32, 11, 0}, 4)
		&& memcmp(child1->elements[13], (unsigned char [4]){3, 32, 12, 0}, 4)
		&& memcmp(child1->elements[14], (unsigned char [4]){3, 32, 13, 0}, 4)
		&& memcmp(child1->elements[15], (unsigned char [4]){3, 32, 14, 0}, 4)) {
	...
	if (memcmp(array.root->elements[0], (unsigned char [4]){3, 15, 144, 0}, 4)) {
	...
	if (memcmp(child0->elements[0], (unsigned char [4]){3, 0, 126, 0}, 4)
		...
		&& memcmp(child0->elements[13], (unsigned char [4]){3, 14, 126, 0}, 4)
		&& memcmp(child0->elements[14], (unsigned char [4]){3, 15, 126, 0}, 4)
		&& memcmp(child0->elements[15], (unsigned char [4]){3, 15, 143, 0}, 4)) {
		printf("TAKE FROM LEFT CHILD 0 DATA FAIL\n");
		return 1;
	}
	// Check child 1
	...
	// Generate keys
	int size = 52800;
	unsigned char * keys5 = malloc(size);
	...
	unsigned char * itKey = CBRangeIteratorGetPointer(&rit);
	...
	unsigned char * keys6 = malloc(size);
	for (int x = 0; x < size; x += 3) {
		...
		CBAssociativeArrayGetLast(&array, &it);
		unsigned char * key = (unsigned char *)it.node->elements[it.index];
		if (key[1] != ((x/3) >> 8) || key[2] != (unsigned char)(x/3)) {
			printf("INSERT GET LAST FAIL\n");
			return 1;
		}
	}
	CBRangeIterator iter = {(unsigned char []){2,0,0}, (unsigned char []){2,0,0}};
	for (int x = 0; x < size; x += 3) {
		((unsigned char *)iter.maxElement)[1] = (x/3 + (x % 3)) >> 8;
		((unsigned char *)iter.maxElement)[2] = x/3 + (x % 3);
		for (int y = 0; y <= x; y += 3) {
			((unsigned char *)iter.minElement)[1] = (y/3) >> 8;
			((unsigned char *)iter.minElement)[2] = y/3;
			if (! CBAssociativeArrayRangeIteratorLast(&array, &iter)) {
				printf("RANGE ITERATOR TO LAST FAIL %u - %u\n",x,y);
				return 1;
			}
			unsigned char * itKey = CBRangeIteratorGetPointer(&iter);
			if (itKey[1] != ((x/3) >> 8) || itKey[2] != (unsigned char)(x/3)) {
	...
	// Test for each macro
	int x = 0;
	CBAssociativeArrayForEach(unsigned char * el, &array){
		if (el[1] != ((x/3) >> 8) || el[2] != (unsigned char)(x/3)) {
