...
int main(){
	...
	uint8_t * hash1 = CBSha256(CBByteArrayGetData(payload),payload->length);
	...
	alert->displayedComment = CBNewByteArrayWithDataCopy((uint8_t *)"See bitcoin.org/feb20 if you have trouble connecting after 20 February", 70, &events);
